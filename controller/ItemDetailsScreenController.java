...
public class ItemDetailsScreenController {
    ...
    public void updateInfo(User user) {
    	...
    	//Attempts to load image will print to the console if it is not able to be found.
    	Image image;
		try {
		...
		//If the stock is less than or equal to 0 than the add to order button is hidden since it should
    ...
    /*
     * addToOrder takes will run when the correct button is pressed and will add the shoe currently
     * displaying to the cart of the user
     * Parameters: 
     * ActionEvent event: This lets the program know that the user has clicked the button and to add to 
     * the cart
     * Returns:
     * No returns but curUser has it's cart updated with a new shoe of the current shoe displayed.
     */
